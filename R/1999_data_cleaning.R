...
library(haven)
library(CCA)
liver <- read_dta("./liver/DS0129/25501-0129-Data.dta")
vocs <- read_dta("./vocs/25501-0133-Data.dta")
...
#Supplements data--------------------------------------------------------
stroke <- read_dta("./DS0226/25501-0226-Data.dta")
diabete <- read_dta("./diabete/DS0210/25501-0210-Data.dta")
hepatitis <- read_dta("./hepatitis/DS0113/25501-0113-Data.dta")
smoke <- read_dta("./smoke/DS0242/25501-0242-Data.dta")
drink <- read_dta("./drink/DS0202/25501-0202-Data.dta")
