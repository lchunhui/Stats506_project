...
// inspect the significance of raw coefficients for each set of the canonical variates
canon (v2 benzene oxylene mpxylene ethylbenzene mtbe toluene chloroform tetrachloroethene trichloroethene) (albumin alt alp ast ggt ldh tb), first(1) stderr
